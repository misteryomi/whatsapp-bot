...
var initializeRequest = (phone_no, oracle_number, session_hash) => {
  var query = "INSERT into `state_requests` (phone_no, oracle_number, session_hash) VALUES ('" + phone_no + "', '" + oracle_number + "', '" + session_hash + "')";
...
var updateRecord = (phone_no, field, value, session_hash) => {
  var query = "UPDATE `state_requests` SET `" + field + "` = '" + value + "', `updated_at` = NOW() WHERE `phone_no` = '" + phone_no + "' AND session_hash = '" + session_hash + "'";
